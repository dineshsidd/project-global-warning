...
dt VARCHAR(0) NULL,
land_average_temperature VARCHAR(0) NULL,
land_average_temperature_uncertainty VARCHAR(0) NULL,
land_max_temperature VARCHAR(0) NULL,
land_max_temperature_uncertainty VARCHAR(0) NULL,
land_min_temperature VARCHAR(0) NULL,
land_min_temperature_uncertainty VARCHAR(0) NULL,
land_and_ocean_average_temperature VARCHAR(0) NULL,
land_and_ocean_average_temperature_uncertainty VARCHAR(0) NULL
);
